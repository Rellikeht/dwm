...
static const char *dmenucmd[] = {"sh", "-c", "exec ~/.dwm/drun.sh", NULL};
static const char *dmenuscr[] = {
    "sh", "-c", "ls -d --color=never ~/.dscripts/* | dmenu | sh -s", NULL};
static const char *rofi[] = {"rofi", "-show", "run", NULL};
static const char *rofic[] = {"rofi", "-show", "calc", NULL};
static const char *termcmd[] = {"st", NULL};
static const char *termtab[] = {"sh", "-c", "exec tabbed st -w", NULL};
static const char *alacrt[] = {"sh", "-c", "exec tabbed alacritty --embed",
                               NULL};
...
static const char *poweroff[] = {"sh", "-c", "exec loginctl poweroff", NULL};
static const char *susp[] = {"sh", "-c", "exec ~/.local_scrs/suspend1.sh",
                             NULL};
static const char *bsusp[] = {"sh", "-c", "exec ~/.local_scrs/suspend2.sh",
                              NULL};
static const char *isusp[] = {"sh", "-c", "exec ~/.local_scrs/suspend3.sh",
                              NULL};

// static const char *plumb[]  = { "sh", "-c", "xclip -o | sh -s | xmessage
// -file -", NULL }; static const char *plumbc[]  = { "sh", "-c", "xclip -o | sh
// -s | xclip -o | xclip -selection clipboard -i", NULL };
static const char *dclip[] = {
    "sh", "-c", "echo | dmenu && xclip -o | xclip -selection clipboard -i",
    NULL};
static const char *clip[] = {"sh", "-c",
                             "xclip -o | xclip -selection CLIPBOARD -i", NULL};
...
static const char *qwerty[] = {"sh", "-c", "exec xmodmap ~/.xmodmap/qwerty",
                               NULL};
static const char *workman[] = {"sh", "-c", "exec xmodmap ~/.xmodmap/workman",
                                NULL};
