...
/* The first element is for all-tag view, following i-th element
 * corresponds to */
/* tags[i]. Layout is referred using the layouts array index.*/
static int def_layouts[1 + LENGTH(tags)] = {
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2
};
...
static const char *dmenucmd[] = {
    "sh", "-c", "~/.dwm/drun.sh", NULL
};
static const char *dmenuscr[] = {
    "sh",
    "-c",
    "ls -d --color=never ~/.dscripts/* | dmenu | sh -s",
    NULL
};
...
static const char *termtab[] = {
    "sh", "-c", "tabbed st -w", NULL
};
static const char *alacrt[] = {
    "sh", "-c", "tabbed alacritty --embed", NULL
};
static const char *urxvtt[] = {
    "sh", "-c", "tabbed urxvt -embed", NULL
};
...
static const char *poweroff[] = {
    "sh", "-c", "loginctl poweroff", NULL
};
static const char *susp[] = {
    "sh", "-c", "~/.local_scrs/suspend1.sh", NULL
};
static const char *bsusp[] = {
    "sh", "-c", "~/.local_scrs/suspend2.sh", NULL
};
static const char *isusp[] = {
    "sh", "-c", "~/.local_scrs/suspend3.sh", NULL
};

// static const char *plumb[]  = { "sh", "-c", "xclip -o | sh -s
// | xmessage -file -", NULL }; static const char *plumbc[]  = {
// "sh", "-c", "xclip -o | sh -s | xclip -o | xclip -selection
// clipboard -i", NULL };
static const char *dclip[] = {
    "sh",
    "-c",
    "echo | dmenu && xclip -o | xclip -selection clipboard -i",
    NULL
};
static const char *clip[] = {
    "sh", "-c", "xclip -o | xclip -selection CLIPBOARD -i", NULL
};
static const char *passm[] = {"passmenu", NULL};
static const char *passt[] = {"passmenu --type", NULL};

static const char *scr1[] = {
    "sh", "-c", "~/.dwm/scr1.sh", NULL
};
static const char *scr2[] = {
    "sh", "-c", "~/.dwm/scr2.sh", NULL
};
static const char *scr3[] = {
    "sh", "-c", "~/.dwm/scr3.sh", NULL
};
static const char *scr4[] = {
    "sh", "-c", "~/.dwm/scr4.sh", NULL
};

/* static const char *mocp[] = { */
/*     "sh", "-c", "~/.dwm/mode.sh mocp", NULL */
/* }; */

/* static const char *cmus[] = { */
/*     "sh", "-c", "~/.dwm/mode.sh cmus", NULL */
/* }; */

// TODO monitors
static const char *dispm[] = {
    "sh", "-c", "~/.local_scrs/dispm.sh", NULL
};

static const char *qwerty[] = {
    "sh", "-c", "xmodmap ~/.xmodmap/qwerty", NULL
};
static const char *workman[] = {
    "sh", "-c", "xmodmap ~/.xmodmap/workman", NULL
};
...
static Key keys[] = {
    ...
    {
     MODKEY | ControlMask,
     XK_space, focusmaster,
     {0},
     },
    {
     MODKEY | ShiftMask,
     XK_space, togglefloating,
     {0},
     },
    {
     MODKEY, XK_0,
