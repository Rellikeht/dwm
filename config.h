...
// static char *dmenucmd_ctrl[] = { "sh", "-c", LOCAL_DSCR_ARG("dmenucmd_ctrl", "exec dmenu_run -m", "0"), NULL };
...
// static char *alt_runner_ctrl[] = { "sh", "-c", LOCAL_DSCR_ARG("alt_runner_ctrl", "exec rofi -show run -matching fuzzy -m", "0"), NULL };
...
static char *suspend[]  = { "sh", "-c", LOCAL_DSCR("suspend", "slock"), NULL };
static char *suspend_shift[]  = { "sh", "-c", LOCAL_DSCR("suspend_shift", "systemctl suspend"), NULL };
static char *suspend_ctrl[]  = { "sh", "-c", LOCAL_DSCR("suspend_ctrl", "loginctl suspend"), NULL };
static char *pass_man[]  = { "sh", "-c", LOCAL_DSCR("pass_man", "passmenu"), NULL };
static char *pass_man_shift[]  = { "sh", "-c", LOCAL_DSCR("pass_man_shift", "passmenu-otp"), NULL };
static char *pass_man_ctrl[]  = { "sh", "-c", LOCAL_DSCR("pass_man_ctrl", "passmenu-otp"), NULL };
static char *mon_man[]  = { "sh", "-c", LOCAL_DSCR("mon_man", EMPTY_CMD), NULL };
static char *mon_man_shift[]  = { "sh", "-c", LOCAL_DSCR("mon_man_shift", EMPTY_CMD), NULL };
static char *mon_man_ctrl[]  = { "sh", "-c", LOCAL_DSCR("mon_man_ctrl", EMPTY_CMD), NULL };
