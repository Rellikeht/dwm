...
static char selfgcolor[]            = "#02aacd";
static char selbordercolor[]        = "#124578";
...
static char *dmenucmd[] = { "sh", "-c", "exec dmenu_run", NULL };
static char *termcmd[]  = { "sh", "-c", "exec st", NULL };
static char *tab_termcmd[]  = { "tabbed", "st", "-w", NULL };
...
ResourcePref resources[] = {
		...
		{ "tab_termcmd",      	STRING,  &tab_termcmd[1] },
};
