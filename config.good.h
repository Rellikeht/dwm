...
static const char *pqute[]  = { "qutebrowser", "-T" };
static const char *qterm[]  = { "qterminal", NULL };
static const char *volp[]  = { "amixer", "-c 0 -- sset Master 3dB+" };
static const char *volm[]  = { "amixer", "-c 0 -- sset Master 3dB-" };
static const char *ssusp[]  = { "loginctl",  "suspend && slock" };
static const char *bsusp[]  = { "i3lock-fancy",  "-p && loginctl suspend" };
static const char *isusp[]  = { "i3lock", "-t -i ~/.bg.lock.png && loginctl suspend" };
static const char *xra[]  = { "xrandr",  "--output HDMI-1 --mode 1920x1080" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_w,      tabmode,        {-1} },
